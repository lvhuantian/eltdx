...
COMMANDS: dict[str, CommandSpec] = {
    ...
    "legacy_quotes": CommandSpec(0x053E, "legacy_quotes", "quotes", "legacy", False, "0x053e-旧版批量行情接口.md"),
    ...
    "file_content": CommandSpec(0x06B9, "file_content", "resources", "read", False, "0x06b9-服务器文件读取接口.md"),
