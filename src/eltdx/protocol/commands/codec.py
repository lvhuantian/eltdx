...
from .resources import build_file_content_frame, parse_file_content_payload
...
BUILDERS: dict[int, Builder] = {
    ...
    TYPE_FILE_CONTENT: build_file_content_frame,
    ...
    TYPE_LEGACY_QUOTES: build_legacy_quotes_frame,
...
PARSERS: dict[int, Parser] = {
    ...
    TYPE_FILE_CONTENT: parse_file_content_payload,
    ...
    TYPE_LEGACY_QUOTES: parse_legacy_quotes_payload,
